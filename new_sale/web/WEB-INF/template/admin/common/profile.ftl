...
<head>
    ...
    <link href="${base}/resources/admin/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
...
[#include "/admin/common/navbar.ftl"]
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>${message("admin.change.password")}</h2>
                <ol class="breadcrumb">
                    <li>
                    ${message("admin.title.system")}
                    </li>
                    <li class="active">
                        <strong>${message("admin.change.password")}</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                        ...
                        <div class="ibox-content">
                            <form id="inputForm" METHOD="post" class="form-horizontal" action="save.jhtml">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">${message("admin.profile.currentPassword")}</label>
                                    <div class="col-sm-4"><input name="currentPassword" type="text" placeholder='${message("admin.profile.currentPassword")}' class="form-control" required/></div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 control-label">${message("admin.profile.newPassword")}</label>
                                    <div class="col-sm-4"><input name="password" type="password" placeholder='${message("admin.profile.newPassword")}' class="form-control" required/></div>
                                </div>

...
import com.ns.warlock.EnumConverter;
...
public final class SettingUtils {
    ...
    public static Setting get() {
        ...
        if (cacheElement != null) {
            ...
            setting = new Setting();
            try {
                File projectXmlFile = new ClassPathResource(CommonAttributes.PROJECT_XML_PATH).getFile();
                Document document = new SAXReader().read(projectXmlFile);
                List<Element> elements = document.selectNodes("/project/setting");

        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>${message("admin.group.level.create")}</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                        ...
                        <div class="ibox-content">
                            <form id="inputForm" method="post" class="form-horizontal" action="save.jhtml">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"><input id="levelName" name="groupLevelName" type="text" class="form-control" required/></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4"><input id="discountRate" name="discountRate" type="number" class="form-control" required/></div>
                                </div>

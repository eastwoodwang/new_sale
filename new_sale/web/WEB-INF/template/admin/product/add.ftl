    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <strong>${message("admin.product.add")}</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <form id="inputForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="save.jhtml">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tabs-container">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <!-- <li ><a data-toggle="tab" href="#tab-2">${message("admin.product.image")}</a></li> -->
                            </ul>
                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4"><input id="name" name="name" type="text" class="form-control" required/></div>
                                        </div>

                                        [#--<div class="form-group">--]
                                            [#--<label class="col-sm-2 control-label">${message("admin.product.fullName")}</label>--]
                                            [#--<div class="col-sm-4"><input id="fullName" name="fullName" type="text" class="form-control" /></div>--]
                                        [#--</div>--]

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">${message("admin.product.price")}</label>
                                            <div class="col-sm-4"><input id="price" name="price" type="text" class="form-control" required/></div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">${message("admin.product.memberPrice")}</label>
                                            <div class="col-sm-4"><input id="memberPrice" name="memberPrice" type="text" class="form-control" /></div>
                                        </div>

                                        [#--<div class="form-group">--]
                                            [#--<label class="col-sm-2 control-label">${message("admin.product.weight")}</label>--]
                                            [#--<div class="col-sm-4"><input id="weight" name="weight" type="text" class="form-control" /></div>--]
                                        [#--</div>--]

                                        [#--<div class="form-group">--]
                                            [#--<label class="col-sm-2 control-label">${message("admin.product.unit")}</label>--]
                                            [#--<div class="col-sm-4"><input id="unit" name="unit" type="text" class="form-control" /></div>--]
                                        [#--</div>--]

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">${message("admin.product.stock")}</label>
                                            <div class="col-sm-4"><input id="stock" name="stock" type="text" class="form-control" /></div>
                                        </div>

                                        [#--<div class="form-group">--]
                                            [#--<label class="col-sm-2 control-label">${message("admin.product.stockMemo")}</label>--]
                                            [#--<div class="col-sm-4"><input id="stockMemo" name="stockMemo" type="text" class="form-control" /></div>--]
                                        [#--</div>--]
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="form-control" name= "marketable" id="marketable">
                                                    ...
                                                    <option value="1">${message("common.market")}</option>
                                                    <option value="2">${message("common.inmarket")}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-stripped" id="productImageTable">
                                                    <tr>
                                                        <th class="col-lg-6">${message("admin.product.imageFile")}</th>

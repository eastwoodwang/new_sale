    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    <li class="active">
                        <strong>${message("admin.order.view")}</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="shippingSn" name="shippingSn" value="${order.shippingSn}" type="text" class="form-control" disabled=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        [#if order.shippingStatus == 0]
                                            <input value="${message("admin.order.ShippingStatus.0")}" type="text" class="form-control" disabled=""/>
                                        [/#if]
                                        [#if order.shippingStatus == 1]
                                            <input value="${message("admin.order.ShippingStatus.1")}" type="text" class="form-control" disabled=""/>
                                        [/#if]
                                        [#if order.shippingStatus == 2]
                                            <input value="${message("admin.order.ShippingStatus.2")}" type="text" class="form-control" disabled=""/>
                                        [/#if]
                                    </div>
                                </div>

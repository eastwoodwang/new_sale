...
public class ZXingCodeUtils {
    ...
    public static void main(String[] args) throws WriterException {
        File logoFile = new File("C:\\Users\\1\\Desktop\\test\\logo.png");
        File QrCodeFile = new File("C:\\Users\\1\\Desktop\\test\\qr.png");
        String url = "http://119.27.189.219:8080/admin/login.jsp"; //存放用户多种信息
        String note = "福號記零售";

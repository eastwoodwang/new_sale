        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>${message("admin.member.level.edit")}</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <form id="inputForm" method="post" class="form-horizontal" action="update.jhtml">
                                <input type="text" hidden="hidden" name="id", value="${memberLevelDTO.id}">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">${message("admin.level.levelName")}</label>
                                    <div class="col-sm-4"><input id="levelName" name="levelName" value="${memberLevelDTO.levelName}" type="text" class="form-control" required/></div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 control-label">${message("admin.level.minRange")}</label>
                                    <div class="col-sm-4"><input id="minRange" name="minRange" value="${memberLevelDTO.minRange}" type="number" class="form-control" required/></div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 control-label">${message("admin.level.maxRange")}</label>
                                    <div class="col-sm-4"><input id="maxRange" name="maxRange" value="${memberLevelDTO.maxRange}" type="number" class="form-control" required/></div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 control-label">${message("admin.level.priority")}</label>
                                    <div class="col-sm-4"><input id="priority" name="priority" value="${memberLevelDTO.priority}" type="number" class="form-control" required/></div>
                                </div>

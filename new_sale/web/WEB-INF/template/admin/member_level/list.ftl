...
[#include "/admin/common/navbar.ftl"]
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>${message("admin.level.list")}</h2>
                <ol class="breadcrumb">
                    <li>
                    ${message("admin.title.member")}
                    </li>
                    <li class="active">
                        <strong>${message("admin.level.list")}</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <div class="">
                                <button class="btn btn-primary" type="button" id="createNew" onclick="location.href='../member_level/add.jhtml'">
                            ...
                            <table class="table table-striped table-bordered table-hover " id="dataTable" >
                                ...
                                <tr>
                                    ...
                                    <th>${message("admin.level.levelName")}</th>
                                    <th>${message("admin.level.minRange")}</th>
                                    <th>${message("admin.level.maxRange")}</th>
                                    <th>${message("admin.level.priority")}</th>
                                    <th>${message("common.operation")}</th>
                                </tr>
                                </thead>
                                <tbody>
                                [#list list as memberLevelDTO]
                                <tr class="gradeA">
                                    <td>
                                        <input type="checkbox" name="ids" value="${memberLevelDTO.id}" />
                                    </td>
                                    <td>${memberLevelDTO.levelName}</td>
                                    <td>${memberLevelDTO.minRange} 元</td>
                                    <td>${memberLevelDTO.maxRange} 元</td>
                                    <td>${memberLevelDTO.priority}</td>
                                    <td>
                                        <a href="edit.jhtml?id=${memberLevelDTO.id}">[${message("common.edit")}]</a>
                                    </td>
                                </tr>
                                [/#list]
                                </tbody>

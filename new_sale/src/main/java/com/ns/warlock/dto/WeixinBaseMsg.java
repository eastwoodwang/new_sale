...
public class WeixinBaseMsg {
	...
	protected String getBaseXml() {
		return "<ToUserName><![CDATA["+this.ToUserName+"]]></ToUserNames>"+"<FromUserName><![CDATA["+this.FromUserName
				+"]]></FromUserName><CreateTime>"+this.CreateTime+"</CreateTime><MsgType><![CDATA["
				+this.MsgType+"]]></MsgType><MsgId><![CDATA["+this.MsgId+"]]></MsgId>";
	}
